package com.nttdata.myztl6.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("myztl6");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("myztl6");
        ...
        config.getMapConfigs().put("com.nttdata.myztl6.domain.*", initializeDomainMapConfig(jHipsterProperties));
